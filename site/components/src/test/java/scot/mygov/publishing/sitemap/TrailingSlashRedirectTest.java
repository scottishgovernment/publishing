...
public class TrailingSlashRedirectTest {
    ...
    @Test
    public void processAddsTrailingSlashIfMissing() {
        // ARRANGE
    ...
    @Test
    public void redirectTargetAddsTrailingSlashBeforeQueryString() {
        // ARRANGE
        TrailingSlashRedirect sut = new TrailingSlashRedirect();
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpServletResponse response = mock(HttpServletResponse.class);
    ...
    @Test
    public void processIgnoresPathWithTrailingSlashes() {
        // ARRANGE
        TrailingSlashRedirect sut = new TrailingSlashRedirect();
        HttpServletRequest request = mock(HttpServletRequest.class);
        HttpServletResponse response = mock(HttpServletResponse.class);
