...
@HippoEssentialsGenerated(internalName = "publishing:tenancyagreementform")
@Node(jcrType = "publishing:tenancyagreementform")
public class TenancyAgreementForm extends Base {
