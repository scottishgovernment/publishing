...
@HippoEssentialsGenerated(internalName = "publishing:smartanswersingleselectoption")
@Node(jcrType = "publishing:smartanswersingleselectoption")
public class Smartanswersingleselectoption extends HippoCompound {
