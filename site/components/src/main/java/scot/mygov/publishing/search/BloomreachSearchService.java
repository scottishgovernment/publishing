package scot.mygov.publishing.search;
...
public class BloomreachSearchService implements SearchService {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(scot.mygov.publishing.search.BloomreachSearchService.class);
