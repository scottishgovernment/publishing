...
@HippoEssentialsGenerated(internalName = "publishing:contentdocument")
@Node(jcrType = "publishing:contentdocument")
public class ContentDocument extends BaseDocument {
    @HippoEssentialsGenerated(internalName = "publishing:introduction")
    public String getIntroduction() {
        return getSingleProperty("publishing:introduction");
    }
