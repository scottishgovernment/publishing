...
After your project is set up, access the CMS at <http://localhost:8080/cms> and the site at <http://localhost:8080/publishing>.
...
as scot.mygov.publishing/publishing:0.0.1-SNAPSHOT
