...
public class ExportDialog extends Dialog<WorkflowDescriptor> {
    ...
    public ExportDialog(final ISearchContext searcher) {
        ...
        Label countText = new Label("counttext", MessageFormat.format(
                new StringResourceModel("export-confirmation-subtext",
                        ExportDialog.this).getString(), getCountSelectedDocuments()
        ));
        add(countText);
        ...
        exportCSVLink = new ResourceLink<String>("exportCSV", getResource()) {
            ...
            public boolean isEnabled(){
                return searcher.getSelectedDocuments().hasNext();
            }
    ...
    protected byte[] createCsvData() {
        ...
        while (nodeIterator.hasNext()) {
            ...
            try {
                ...
                LOG.error("An exception occurred while exporting CSV.", e);
            }
        }
    ...
    private List<String> constructPropertiesList(final Node handle) throws RepositoryException {
    ...
    private Node getDocumentVariantByHippoStdState(final Node handle, final String hippoStdState) throws RepositoryException {
