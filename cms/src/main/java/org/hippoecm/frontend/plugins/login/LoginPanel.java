...
/*TODO This is a fork with the purpose to improve locale handling in the #getSelectedLocale. Check the origin class for changes during upgrades.
Remove when https://issues.onehippo.com/browse/CMS-13954 is part of product*/
...
public class LoginPanel extends Panel {
    ...
    private Locale getSelectedLocale() {
        ...
        //Fork change in this line
        return LocaleUtils.toLocale(selectedLocale);
    }
