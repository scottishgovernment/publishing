...
// todo: two hardcoded <a href="qqq"> to internal links. how can we make those dynamic?
...
const modelTenancyForm = {
            ...
            .finally(data => {
                this.form.formDataObject = {
                    ...
                    "lettingAgent": {
                        ...
                        "email": "jonathan.a.sutcliffe@gmail.com"
                    },
                    ...
                    "landlords": [
                        ...
                        },
                        {
                            "email": "jonathan.a.sutcliffe@gmail.com",
                            "name": "Jonathan Sutcliffe",
                            "registrationNumber": "123456/123/12345",
                            "telephone": "01578750763"
                        }
                    ],
    ...
    prepareFormDataForPost(formData) {
        ...
        // todo: return optional terms to expected format
    ...
    setupValidation() {
        commonForms.atLeastOneTenant = function () {
            ...
            // commonForms.toggleCurrentErrors(tenantRepeater, valid, 'invalid-required', message);
