...
class MultiPageForm {
    ...
    goToPage(page, addToHistory = true) {
        ...
        temporaryFocus(document.getElementById('main-content'));
        this.initDSComponents();
    }

    /**
     * Get page/section from the URL and render the matchign page
     */
    ...
    populateNavButtons(page) {
        const navButtonsContainer = document.querySelector(`[data-slug="${page.slug}"] .form-container__nav`);
     ...
     */
    showPage(page) {
        [].slice.call(document.querySelectorAll('.form-page')).forEach(formPage => {
