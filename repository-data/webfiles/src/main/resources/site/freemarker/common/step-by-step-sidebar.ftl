...
<#if primaryStepByStep??>
    <nav class="ds_step-navigation  ds_step-navigation--small" aria-labelledby="step-navigation-sidebar" data-module="ds-step-navigation">
        ...
        <div class="ds_accordion  ds_accordion--small" data-module="ds-accordion">
            ...
            <ol class="ds_step-navigation__list">
                <#assign stepcount = 0 />
                ...
                <#list primaryStepByStep.stepByStepGuide.steps as step>
                    ...
                    <li value="${stepcount}" class="<#if isactivestep>ds_accordion-item--open  ds_current</#if>  ds_accordion-item  ds_accordion-item--small  <#if step.labeltype == "or">ds_step-navigation__or<#elseif step.labeltype == "and">ds_step-navigation__and</#if>" <#if isactivestep>aria-current="step"</#if>>
