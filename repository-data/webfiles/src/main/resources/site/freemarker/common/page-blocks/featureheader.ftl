...
<#if verticalalign?has_content><#if verticalalign == 'top'>  ds_feature-header--top</#if></#if>">
        ...
        <#if document?has_content>
            <div class="ds_feature-header__primary">
                ...
                <#if document.descriptionContentBlocks?has_content>
        ...
        <#elseif editMode>
            ...
            <div class="ds_feature-header__secondary<#if imagenomargin>  ds_feature-header__secondary--no-padding</#if><#if imagealigndesktop??>  ds_cb__poster--${imagealigndesktop}</#if><#if imagealignmobile??>  ds_feature-header__secondary--${imagealignmobile}-mobile</#if>">
                <@placeholderimage/>
            </div>
