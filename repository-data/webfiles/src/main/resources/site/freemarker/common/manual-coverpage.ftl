    ...
    <div class="ds_wrapper">
        <main <@lang document/> id="main-content" class="ds_layout  ds_layout--article">
            <div class="ds_layout__header">
                ...
                <#if publication.summary?has_content>
                    <div class="ds_leader-first-paragraph">
                        ...
                        <#if documents??>
                            <a href="<@hst.link hippobean=documents/>" class="ds_button  ds_button--secondary  ds_button--has-icon  ds_no-margin">
                                This Publication is also a PDF
            ...
            <div class="ds_layout__content">
                <h4>Pages in this publication:</h4>
                <ul >
